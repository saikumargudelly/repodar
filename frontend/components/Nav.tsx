      ...
      <div style={{ display: "flex", alignItems: "center", gap: "10px", userSelect: "none" }}>
        <div className="brand-icon" style={{ width: "24px", height: "24px" }}>
          ...
          <svg viewBox="0 0 24 24" width="14" height="14" fill="none">
            ...
            <path d="M12,8 C9.79,8 8,9.79 8,12 C8,14.21 9.79,16 12,16 C13.5,16 14.8,15.2 15.5,14 L13.5,13 C13.2,13.6 12.6,14 12,14 C10.9,14 10,13.1 10,12 C10,10.9 10.9,10 12,10 C13.1,10 14,10.9 14,12" fill="none" stroke="currentColor" stroke-width="1.8" />
